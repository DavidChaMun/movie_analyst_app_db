...
CREATE TABLE movie_db.movie (title VARCHAR(255) PRIMARY KEY, `release` VARCHAR(255), score INTEGER, reviewer VARCHAR(255), publication VARCHAR(255), pending VARCHAR(10), FOREIGN KEY (reviewer) REFERENCES reviewer(name) ON DELETE CASCADE, FOREIGN KEY (publication) REFERENCES publication(name) ON DELETE CASCADE);
...
INSERT INTO movie_db.movie (title, `release`, score, reviewer, publication, pending) VALUES ('Suicide Squad', '2016', '8', 'Robert Smith','The Daily Reviewer', "False");
INSERT INTO movie_db.movie (title, `release`, score, reviewer, publication, pending) VALUES ('Batman vs. Superman', '2016', '6', 'Chris Harris', 'International Movie Critic', "False");
INSERT INTO movie_db.movie (title, `release`, score, reviewer, publication, pending) VALUES ('Captain America: Civil War', '2016', '9', 'Andrew West', 'MyNextReview', "False");
INSERT INTO movie_db.movie (title, `release`, score, reviewer, publication, pending) VALUES ('Avengers: Age of Ultron', '2015', '7', 'Mindy Lee', 'Movies n\' Games', "False");
INSERT INTO movie_db.movie (title, `release`, score, reviewer, publication, pending) VALUES ('Deadpool', '2016', '9', 'Andrew West', 'MyNextReview', "False");
INSERT INTO movie_db.movie (title, `release`, score, reviewer, publication, pending) VALUES ('Ant-Man', '2015', '8', 'Martin Thomas', 'TheOne', "False");
INSERT INTO movie_db.movie (title, `release`, score, reviewer, publication, pending) VALUES ('Guardians of the Galaxy', '2014', '10', 'Anthony Miller', 'ComicBookHero.com', "False");
INSERT INTO movie_db.movie (title, `release`, score, reviewer, publication, pending) VALUES ('Superman: Homecoming', '2017', '10', 'Chris Harris', 'International Movie Critic', 'True');
INSERT INTO movie_db.movie (title, `release`, score, reviewer, publication, pending) VALUES ('Wonder Woman', '2017', '8', 'Martin Thomas', 'TheOne', 'True');
INSERT INTO movie_db.movie (title, `release`, score, reviewer, publication, pending) VALUES ('Doctor Strange', '2016', '7', 'Anthony Miller', 'ComicBookHero.com', 'True');
